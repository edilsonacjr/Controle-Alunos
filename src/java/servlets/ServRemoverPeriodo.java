 ...
 * @author josepedro
 */
@WebServlet(name = "ServRemoverPeriodo", urlPatterns = {"/ServRemoverPeriodo"})
public class ServRemoverPeriodo extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           /* TODO output your page here. You may use following sample code. */
            ...
            out.println("</div>"
                    ...
                    + "        <h1 class=\"page-header\">Periodo Removido com Sucesso!!!! &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\n"
                    + "          <br>\n"
                    + "        </h1>"
                    ...
                    + "                <button id=\"button1id\" name=\"button1id\" class=\"btn btn-success\" onclick=\"document.forms[0].action = 'removerPeriodo.jsp'; return true;\">Voltar</button>\n"
                    + "              </div>\n"
                    + "</fieldset>"
                    + "</form>");
            out.println("</body>");
