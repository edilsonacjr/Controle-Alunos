 ...
 * @author josepedro
 */
@WebServlet(name = "ServAtualizarNota", urlPatterns = {"/ServAtualizarNota"})
public class ServAtualizarNota extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
          /* TODO output your page here. You may use following sample code. */
            ...
            out.println("</div>"
                    ...
                    + "        <h1 class=\"page-header\">Nota Atualizada com Sucesso!!!! &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\n"
                    + "          <br>\n"
                    + "        </h1>"
                    + "<fieldset>"
                    ...
                    + "                <button id=\"button1id\" name=\"button1id\" class=\"btn btn-success\" onclick=\"document.forms[0].action = 'atualizaNota.jsp'; return true;\">Voltar</button>\n"
                    + "              </div>\n"
                    + "</fieldset>"
                    + "</form>");
            out.println("</body>");
