 ...
 * @author josepedro
 */
@WebServlet(name = "ServAtualizarFalta", urlPatterns = {"/ServAtualizarFalta"})
public class ServAtualizarFalta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</div>"
                    ...
                    + "                <button id=\"button1id\" name=\"button1id\" class=\"btn btn-success\" onclick=\"document.forms[0].action = 'atualizaFalta.jsp'; return true;\">Voltar</button>\n"
                    + "              </div>\n"
                    + "</fieldset>"
                    + "</form>");
            out.println("</body>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // f.getMateria().setId(Integer.parseInt(request.getParameter("materia")));
        ...
        try {
            ...
            Logger.getLogger(ServAtualizarFalta.class.getName()).log(Level.SEVERE, null, ex);
        }
