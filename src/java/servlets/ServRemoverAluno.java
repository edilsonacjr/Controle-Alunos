 ...
 * @author josepedro
 */
@WebServlet(name = "ServRemoverAluno", urlPatterns = {"/ServRemoverAluno"})
public class ServRemoverAluno extends HttpServlet {
    ...
    response.setContentType("text/html;charset=UTF-8");
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</div>"
                    ...
                    + "        <h1 class=\"page-header\">Aluno Removido com Sucesso!!!! &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;\n"
                    + "          <br>\n"
                    + "        </h1>"
                    ...
                    + "                <button id=\"button1id\" name=\"button1id\" class=\"btn btn-success\" onclick=\"document.forms[0].action = 'removerAluno.jsp'; return true;\">Voltar</button>\n"
                    + "              </div>\n"
                    + "</fieldset>"
                    + "</form>");
            out.println("</body>");
