                                            ...
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 text-right">
                                                        <button id="button1id" name="edita" class="btn btn-success" onclick="form.action = 'ServEditarProfessor';" value="${professor.id}">Editar</button>
                                                        <button id="button2id" name="exclui" class="btn btn-danger" onclick="form.action = 'ServExcluirProfessor';" value="${professor.id}">Excluir</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </td>
